...
declare module DLSModule {
  ...
  interface dls {
    ...
    documentHistory(uri: string): document-history);
    ...
    documentManage(uri: string, deep: boolean, annotation?: item()): void;

    /** Removes the specified document from management. You must have update permissions on the document to unmanage the document. **/
    documentUnmanage(uri: string, deep: boolean, removeVersions: boolean): void;
    ...
    documentCheckout(uri: string, deep: boolean, annotation?: item(), timeout?: number): void;
    ...
    documentVersionDelete(uri: string, version: number, retainHistory: boolean): void;
    ...
    documentVersionsQuery(uri: string): properties-fragment-query;
    ...
    documentDelete(uri: string, keepOldVersions: boolean, retainHistory: boolean): void;
    ...
    retentionRule(name: string, comment: item(), numVersions: number, duration: duration, documentQueryText: string, documentQuery: query): retention-rule);
    ...
    retentionRuleInsert(rules: retention-rule)): void;

    /** This function returns the specified retention rules from the database. **/
    retentionRules(names: string): retention-rule);
    ...
    documentRetentionRules(uri: string): retention-rule);
    ...
    purge(delete: boolean, retainHistory: boolean): string;
    ...
    documentPurge(uri: string, delete: boolean, retainHistory: boolean): string;
    ...
    linkExpand(context: node(), ref: include), restriction: query): node();
    ...
    linkReferences(node: node(), restriction: query): string;
    ...
    nodeExpand(node: node(), restriction: query): node();
    ...
    documentAddProperties(uri: string, properties: element()): void;
    ...
    documentSetPermissions(uri: string, permissions: item()): void;
    ...
    documentSetProperties(uri: string, properties: element()): void;
    ...
    documentSetProperty(uri: string, property: element()): void;
    ...
    documentRemovePermissions(uri: string, permissions: item()): void;
    ...
    documentRemoveProperties(uri: string, propertyNames: QName): void;
    ...
    documentUpdate(uri: string, doc: node(), annotation: item(), retainHistory: boolean, permissions?: item(), collections?: string, quality?: number, forestIds?: number): string;

    /** This function breaks (unlocks) a checked-out document **/
    breakCheckout(uri: string, deep: boolean): void;
    ...
    documentExtractPart(newUri: string, element: element(), annotation: item(), retainHistory: boolean, permissions?: item(), collections?: string, quality?: number, forestIds?: number): string;
    ...
    documentIncludeQuery(uri: string): query;

    /** This function inserts a document into the database and places the document under management. **/
    documentInsertAndManage(uri: string, deep: boolean, doc: node(), annotation?: item(), permissions?: item(), collections?: string, quality?: number, forestIds?: number): string;

    /** This function allows you to checkout, update, and checkin a managed document in a single transaction. **/
    documentCheckoutUpdateCheckin(uri: string, doc: node(), annotation: item(), retainHistory: boolean, permissions?: item(), collections?: string, quality?: number, forestIds?: number): string;
    ...
    validateAllDocuments(verbose: boolean): validation-results) ;

    /** Returns a report describing the status of an upgrade from a pre-MarkLogic 8 DLS repository. **/
    latestValidationResults(): validation-results);
    ...
    setUpgradeStatus(promote: boolean): upgrade-status);

    /** This function.... **/
    updateValidationResults(results: validation-results)): void;
