...
declare module StringBuiltins {
  ...
  interface fn {
    ...
    concat(parameter1: anyAtomicType, parameterN?: anyAtomicType,...): string;
    ...
    substring(sourceString: string, startingLoc: double, length?: double): string;
    ...
    stringPad(padString: string, padCount: number): string;
    ...
    escapeUri(uriPart: string, escapeReserved: boolean): string;
