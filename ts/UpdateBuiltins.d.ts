...
declare module UpdateBuiltins {
  ...
  interface xdmp {
    ...
    save(path: string, node: node(), options?: map)): void;
    ...
    documentLoad(location: string, options?: map)): void;
    ...
    documentLoad(temporalCollection: string, location: string, options?: map), options?: Object): void;
    ...
    load(path: string, uri?: string, permissions?: permission), permissions?: Object[], collections?: string, quality?: number, defaultNamespace?: string, options?: string, forestIds?: number): void;
    ...
    documentInsert(uri: string, root: node(), permissions?: permission), permissions?: Object[], collections?: string, quality?: number, forestIds?: number): void;
    ...
    statementSetSystemTime(systemTime: dateTime): void;
    ...
    /** This function inserts a document into the database and stores it as a temporal document. The document will belong to the specified temporal collection to ensure that it can only be updated or deleted using the temporal functions. If a temporal document already exists at the specified URI, this function performs an update instead of an insert. (Note that updates on temporal documents mean that a new document is created in the temporal collection with a different time period.) An exception is thrown if $temporal-collection is not temporal or $collection includes temporal collection(s). **/
    documentInsert(temporalCollection: string, uri: string, root: node(), permissions?: permission), permissions?: Object[], collections?: string, quality?: number, forestIds?: number): void;
    ...
    directoryCreate(uri: string, permissions?: permission), permissions?: Object[], collections?: string, quality?: number, forestIds?: number): void;
    ...
    documentAddPermissions(uri: string, permissions: permission), permissions: Object[]): void;
    ...
    documentRemovePermissions(uri: string, permissions: permission), permissions: Object[]): void;
    ...
    documentSetPermissions(uri: string, permissions: permission), permissions: Object[]): void;
    ...
    lockAcquire(uri: string, scope?: string, depth?: string, owner?: item(), timeout?: number): void;
    ...
    documentSetProperties(uri: string, props: element()): void;

    /** Adds a sequence of properties to the properties of a document. **/
    documentAddProperties(uri: string, props: element()): void;
    ...
    documentSetProperty(uri: string, prop: element()): void;
    ...
    databasePartitionForests(value: anyAtomicType): number;
