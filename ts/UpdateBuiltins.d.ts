...
// Definitions: /Users/gjosten/Projects/github-grtjn/marklogic-typescript-definitions/xml/UpdateBuiltins.xml
...
declare module UpdateBuiltins {
  ...
  interface xdmp {
    ...
    lockForUpdate(uri: xs:string): void;
    ...
    save(path: xs:string, node: node(), options?: (element()|map:map)): void;
    ...
    documentLoad(location: xs:string, options?: (element()|map:map)): void;
    ...
    documentLoad(temporalCollection: xs:string, location: xs:string, options?: (element()|map:map), options?: Object): void;
    ...
    load(path: xs:string, uri?: xs:string, permissions?: element(sec:permission), permissions?: Object[], collections?: xs:string, quality?: xs:int, defaultNamespace?: xs:string, options?: xs:string, forestIds?: xs:unsignedLong): void;
    ...
    documentInsert(uri: xs:string, root: node(), permissions?: element(sec:permission), permissions?: Object[], collections?: xs:string, quality?: xs:int, forestIds?: xs:unsignedLong): void;
    ...
    statementSetSystemTime(systemTime: xs:dateTime): void;
    ...
    /** This function inserts a document into the database and stores it as a temporal document. The document will belong to the specified temporal collection to ensure that it can only be updated or deleted using the temporal functions. If a temporal document already exists at the specified URI, this function performs an update instead of an insert. (Note that updates on temporal documents mean that a new document is created in the temporal collection with a different time period.) An exception is thrown if $temporal-collection is not temporal or $collection includes temporal collection(s). **/
    documentInsert(temporalCollection: xs:string, uri: xs:string, root: node(), permissions?: element(sec:permission), permissions?: Object[], collections?: xs:string, quality?: xs:int, forestIds?: xs:unsignedLong): void;
    ...
    directoryCreate(uri: xs:string, permissions?: element(sec:permission), permissions?: Object[], collections?: xs:string, quality?: xs:int, forestIds?: xs:unsignedLong): void;

    /** Deletes a document from the database. **/
    documentDelete(uri: xs:string): void;
    ...
    collectionDelete(uri: xs:string): void;

    /** Replaces a node. **/
    nodeReplace(old: node(), new: node()): void;
    ...
    nodeInsertBefore(sibling: node(), new: node()): void;

    /** Adds an immediately following sibling to a node. **/
    nodeInsertAfter(sibling: node(), new: node()): void;
    ...
    nodeInsertChild(parent: node(), new: node()): void;
    ...
    documentAddPermissions(uri: xs:string, permissions: element(sec:permission), permissions: Object[]): void;
    ...
    documentRemovePermissions(uri: xs:string, permissions: element(sec:permission), permissions: Object[]): void;
    ...
    documentSetPermissions(uri: xs:string, permissions: element(sec:permission), permissions: Object[]): void;
    ...
    documentSetQuality(uri: xs:string, quality: xs:integer): void;
    ...
    lockAcquire(uri: xs:string, scope?: xs:string, depth?: xs:string, owner?: item(), timeout?: xs:unsignedLong): void;

    /** Unlock a document or directory. Releases the lock created with xdmp:lock-acquire. **/
    lockRelease(uri: xs:string): void;
    ...
    documentSetProperties(uri: xs:string, props: element()): void;

    /** Adds a sequence of properties to the properties of a document. **/
    documentAddProperties(uri: xs:string, props: element()): void;
    ...
    documentSetProperty(uri: xs:string, prop: element()): void;
    ...
    documentAssign(uri: xs:string, forestCount: xs:positiveInteger, assignmentPolicy?: xs:string): xs:positiveInteger;
    ...
    databasePartitionForests(value: xs:anyAtomicType): xs:unsignedLong;
