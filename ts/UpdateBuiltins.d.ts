...
interface xdmpFunctions {
  ...
  save(path: string, node: MLNode<any>, options?: MLNode<any>|{[key:string]:any}): void;
  ...
  documentLoad(location: string, options?: MLNode<any>|{[key:string]:any}): void;
  ...
  load(path: string, uri?: string, permissions?: Object[], collections?: string, quality?: number, defaultNamespace?: string, options?: string, forestIds?: string): void;
  ...
  documentInsert(uri: string, root: MLNode<any>, permissions?: Object[], collections?: string, quality?: number, forestIds?: string): void;
  ...
  directoryCreate(uri: string, permissions?: Object[], collections?: string, quality?: number, forestIds?: string): void;
  ...
  collectionDelete(uri: string): void;
    ...
    /** Replaces a node. **/
  nodeReplace(old: MLNode<any>, new_: MLNode<any>): void;

    /** Deletes a node from the database. On-the-fly constructed nodes cannot be deleted. **/
  nodeDelete(old: MLNode<any>): void;

    /** Adds an immediately preceding sibling to a node. **/
  nodeInsertBefore(sibling: MLNode<any>, new_: MLNode<any>): void;

    /** Adds an immediately following sibling to a node. **/
  nodeInsertAfter(sibling: MLNode<any>, new_: MLNode<any>): void;
  ...
  nodeInsertChild(parent: MLNode<any>, new_: MLNode<any>): void;
  ...
  merge(options?: MLNode<any>|{[key:string]:any}): void;
  ...
  documentSetProperties(uri: string, props: MLNode<any>): void;

    /** Adds a sequence of properties to the properties of a document. **/
  documentAddProperties(uri: string, props: MLNode<any>): void;
  ...
  documentRemoveProperties(uri: string, propertyNames: xs.QName): void;
  ...
  documentSetProperty(uri: string, prop: MLNode<any>): void;
  ...
  databasePartitionForests(value: any): string;
...
interface temporalFunctions {
  ...
  statementGetSystemTime(): void;
    ...
    /** This function inserts a document into the database and stores it as a temporal document. The document will belong to the specified temporal collection to ensure that it can only be updated or deleted using the temporal functions. If a temporal document already exists at the specified URI, this function performs an update instead of an insert. (Note that updates on temporal documents mean that a new document is created in the temporal collection with a different time period.) An exception is thrown if $temporal-collection is not temporal or $collection includes temporal collection(s). **/
  documentInsert(temporalCollection: string, uri: string, root: MLNode<any>, permissions?: Object[], collections?: string, quality?: number, forestIds?: string): void;
