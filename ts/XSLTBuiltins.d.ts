...
declare module XSLTBuiltins {
  ...
  interface fn {
    ...
    regexGroup(groupNumber: xs:integer): xs:string;
    ...
    systemProperty(propertyName: xs:string): xs:string;
    ...
    elementAvailable(elementName: xs:string): xs:boolean;
    ...
    key(keyName: xs:string, keyValue: xs:string, top?: node()): node();
    ...
    currentGroupingKey(): xs:anyAtomicType;
    ...
    typeAvailable(typeName: xs:string): xs:boolean;
    ...
    functionAvailable(functionName: xs:string, arity?: xs:integer): xs:boolean;
    ...
    unparsedEntityUri(entityName: xs:string): xs:anyURI;
    ...
    unparsedEntityPublicId(entityName: xs:string): xs:string;
