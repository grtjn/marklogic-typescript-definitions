...
declare module DurationDateTimeBuiltins {
  ...
  interface fn {
    ...
    yearsFromDuration(arg: xs:duration): xs:integer;
    ...
    monthsFromDuration(arg: xs:duration): xs:integer;
    ...
    daysFromDuration(arg: xs:duration): xs:integer;
    ...
    hoursFromDuration(arg: xs:duration): xs:integer;
    ...
    minutesFromDuration(arg: xs:duration): xs:integer;
    ...
    secondsFromDuration(arg: xs:duration): xs:decimal;
    ...
    yearFromDateTime(arg: xs:dateTime): xs:integer;
    ...
    monthFromDateTime(arg: xs:dateTime): xs:integer;
    ...
    dayFromDateTime(arg: xs:dateTime): xs:integer;
    ...
    hoursFromDateTime(arg: xs:dateTime): xs:integer;
    ...
    minutesFromDateTime(arg: xs:dateTime): xs:integer;
    ...
    secondsFromDateTime(arg: xs:dateTime): xs:decimal;
    ...
    timezoneFromDateTime(arg: xs:dateTime): xs:dayTimeDuration;

    /** Returns an xs:integer representing the year component in the localized value of $arg. The result may be negative. If $arg is the empty sequence, returns the empty sequence. **/
    yearFromDate(arg: xs:date): xs:integer;

    /** Returns an xs:integer between 1 and 12, both inclusive, representing the month component in the localized value of $arg. If $arg is the empty sequence, returns the empty sequence. **/
    monthFromDate(arg: xs:date): xs:integer;

    /** Returns an xs:integer between 1 and 31, both inclusive, representing the day component in the localized value of $arg. If $arg is the empty sequence, returns the empty sequence. **/
    dayFromDate(arg: xs:date): xs:integer;
    ...
    quarterFromDate(arg: xs:date): xs:integer;
    ...
    weekFromDate(arg: xs:date): xs:integer;
    ...
    yeardayFromDate(arg: xs:date): xs:integer;
    ...
    weekdayFromDate(arg: xs:date): xs:integer;

    /** Returns the timezone component of $arg if any. If $arg has a timezone component, then the result is an xs:dayTimeDuration that indicates deviation from UTC; its value may range from +14:00 to -14:00 hours, both inclusive. Otherwise, the result is the empty sequence. If $arg is the empty sequence, returns the empty sequence. **/
    timezoneFromDate(arg: xs:date): xs:dayTimeDuration;
    ...
    hoursFromTime(arg: xs:time): xs:integer;
    ...
    minutesFromTime(arg: xs:time): xs:integer;

    /** Returns an xs:decimal value between 0 and 60.999..., both inclusive, representing the seconds and fractional seconds in the localized value of $arg. Note that the value can be greater than 60 seconds to accommodate occasional leap seconds used to keep human time synchronized with the rotation of the planet. If $arg is the empty sequence, returns the empty sequence. **/
    secondsFromTime(arg: xs:time): xs:decimal;

    /** Returns the timezone component of $arg if any. If $arg has a timezone component, then the result is an xs:dayTimeDuration that indicates deviation from UTC; its value may range from +14:00 to -14:00 hours, both inclusive. Otherwise, the result is the empty sequence. If $arg is the empty sequence, returns the empty sequence. **/
    timezoneFromTime(arg: xs:time): xs:dayTimeDuration;
    ...
    adjustDateTimeToTimezone(arg: xs:dateTime, timezone?: xs:dayTimeDuration): xs:dateTime;
    ...
    adjustDateToTimezone(arg: xs:date, timezone?: xs:dayTimeDuration): xs:date;
    ...
    adjustTimeToTimezone(arg: xs:time, timezone?: xs:dayTimeDuration): xs:time;
    ...
    subtractDateTimesYieldingYearMonthDuration(srcval1: xs:dateTime, srcval1: xs:dateTime): xdt:yearMonthDuration;
    ...
    subtractDateTimesYieldingDayTimeDuration(srcval1: xs:dateTime, srcval1: xs:dateTime): xdt:dayTimeDuration;
    ...
    datepart(datepart: xs:string, date: xs:genericDateTimeArg): xs:integer;

    /** Returns the count (signed integer) of the specified datepart boundaries crossed between the specified startdate and enddate. **/
    datediff(datepart: xs:string, startdate: any, enddate: any): xs:integer;

    /** Returns a specified date with the specified number interval (signed integer) added to a specified datepart of that date **/
    dateadd(datepart: xs:string, number: xs:integer, date: any): item()
;
