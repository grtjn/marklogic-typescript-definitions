...
interface restFunctions {
  ...
  rewrite(options: Node, matchCriteria: string): string;
  ...
  matchingRequest(options: Node, matchCriteria: string): Node;
  ...
  processRequest(request: Node): Object;
  ...
  checkRequest(options: Node): Node;

}
declare var rest:restFunctions
