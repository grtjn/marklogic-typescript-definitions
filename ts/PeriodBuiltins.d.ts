...
declare module PeriodBuiltins {
  ...
  interface cts {
    ...
    periodCompare(period-1: period, operator: string, period-2: period): boolean;
    ...
    documentPeriod(temporalCollection: string, axis: string, root: node()): dateTime;
    ...
    getLsqt(temporalCollection: string): dateTime;
    ...
    advanceLsqt(temporalCollection: string): dateTime;
