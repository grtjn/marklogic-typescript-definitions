...
interface mathFunctions {
  ...
  linearModel(arg: Array<any>): math.LinearModel;
  ...
  linearModelCoeff(linearModel: math.LinearModel): number;
  ...
  rank(arg: any, arg2: any, options?: string): number;
  ...
  percentRank(arg: any, value: any, options?: string): number;
  ...
  mode(arg: any, options?: string): any;
...
interface ctsFunctions {
  ...
  rank(arg: any, value: any, options?: string): number;
