...
declare module ConvertModule {
  ...
  interface cvt {
    ...
    destinationUri(uri: string, extension: string): string ;
    ...
    partUri(uri: string, part: string): string ;
    ...
    saveConvertedDocuments(sourceUri: string, destinationUri: string, manifest: element(), docs: document-node(), destinationCollections?: string):  empty-sequence() ;
