...
declare module InfoModule {
  ...
  interface info {
    ...
    databaseGetFeature(database: String, previewSettings?: Node, delta?: Boolean): Node;
    ...
    ticketErrors(ticketId: String, start?: Number, pageLength?: Number, sortAscending?: Boolean, filter?: Node): Node;
