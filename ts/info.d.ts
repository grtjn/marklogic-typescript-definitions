...
interface infoFunctions {
  ...
  databaseCreate(databaseName: string, forestsPerHost?: number, group?: string, dataDirectory?: string, securityDb?: string, schemasDb?: string, triggersDb?: string): string;
  ...
  databaseSetFeature(database: string, settings: Node): void;
  ...
  databaseGetFeature(database: string, previewSettings?: Node, delta?: Object): Node;
  ...
  load(dirPath: string, policyName?: string, policyDeltas?: Node, database?: string): string;
  ...
  policySet(policyName?: string, policy?: Node): void;
  ...
  tickets(database?: string, status?: string, customQuery?: Node): string;
  ...
  ticketErrors(ticketId: string, start?: number, pageLength?: number, sortAscending?: Object, filter?: Node): Node;

    /** [DEPRECATED] This function deletes the specified database and its forest. **/
  databaseDelete(databaseName: string, deleteData?: Object): void;

    /** [DEPRECATED] This function returns the error detail associated with the specified error-id. **/
  errorDetail(errorId: string): Node;
  ...
  flowTickets(flowId: string, includeInactive?: Object): string;
...
declare var info:infoFunctions
