...
interface secFunctions {

    /** Creates a new user in the system database for the context database. Returns the user ID of the created user. **/
  createUser(userName: string, description: string, password: string, roleNames: string, permissions: Node, collections: string, externalNames?: string): string;
  ...
  createUserWithRole(userName: string, description: string, password: string, roleNames: string, permissions: Node, collections: string, externalNames: string): string;
  ...
  roleGetDescription(roleName: string): Object;
  ...
  getRoleIds(roleNames?: string): Object;
  ...
  getRoleNames(roleIds: string): Object;
  ...
  createRole(roleName: string, description: string, roleNames: string, permissions: Node, collections: string, compartment?: string, externalNames?: string): Object;
  ...
  createPrivilege(privilegeName: string, action: string, kind: string, roleNames: string): Object;
  ...
  privilegeGetRoles(action: string, kind: string): Object;
  ...
  createAmp(namespace: string, localName: string, documentUri: string, database: string, roleNames: string): Object;
  ...
  ampGetRoles(namespace: string, localName: string, documentUri: string, database: string): Object;

    /** Returns a sequence of role names for the roles directly assigned to the given role ($role-name). **/
  roleGetRoles(roleName: string): Object;
  ...
  getAmp(namespace: string, localName: string, documentUri: string, database: string): Object;
  ...
  getCollection(uri: string): Object;
  ...
  protectCollection(uri: string, permissions: Node): Object;
  ...
  collectionSetPermissions(uri: string, permissions: Node): void;

    /** Add the permissions $permissions to the protected collection identified by $uri. **/
  collectionAddPermissions(uri: string, permissions: Node): void;

    /** Removes the permissions $permissions from the protected collection identified by $uri. **/
  collectionRemovePermissions(uri: string, permissions: Node): void;
  ...
  collectionGetPermissions(uri: string): Object;
  ...
  userPrivileges(userName: string): Object;
  ...
  getUserNames(userIds: string): Object;
  ...
  compartmentGetRoles(compartmentName: string): Node;
  ...
  externalSecurityDocPermissions(): Node;
