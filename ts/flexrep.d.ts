...
declare module FlexRepModule {
  ...
  interface flexrep {
    ...
    configurationCreate(domainId: number, alertingUri?: string): configuration);

    /** This function inserts a replication configuration to the database. **/
    configurationInsert(cfg: configuration)): void;

    /** This function gets the replication configuration for a CPF domain. **/
    configurationGet(domainId: number, assert?: boolean): configuration);
    ...
    configurationDelete(domainId: number): void;
    ...
    targetCreate(cfg: configuration), name: string, urls: string, retrySecondsMin: number, retrySecondsMax: number, documentsPerBatch: number, enabled: boolean, httpOptions: http-options), replicateCpf: boolean, filterModule: string, filterOptions: filter-options), userId?: number, immediatePush?: boolean): configuration);
    ...
    targetDelete(cfg: configuration), targetId: number): configuration);

    /** This function returns the replication targets for a configuration. **/
    configurationTargets(cfg: configuration)): target);

    /** This function returns a specified target for a configuration, or throws an error if it does not exist. **/
    configurationTarget(cfg: configuration), targetId: number, assert?: boolean): target);

    /** This function returns the ID of the named replicaiton target. **/
    configurationTargetGetId(cfg: configuration), targetName: string): number;

    /** This function returns the name of the specified target. **/
    configurationTargetGetName(cfg: configuration), targetId: number): string;

    /** This function returns the URLs for the specified targets. **/
    configurationTargetGetUrls(cfg: configuration), targetId: number): string;

    /** This function returns the value of the minimum retry setting for the replication target. **/
    configurationTargetGetRetrySecondsMin(cfg: configuration), targetId: number): number;

    /** This function returns the value of the documents-per-batch setting for the replication target. **/
    configurationTargetGetDocumentsPerBatch(cfg: configuration), targetId: number): number;

    /** This function returns true if the specified replication target is enabled, otherwise it returns false. **/
    configurationTargetGetEnabled(cfg: configuration), targetId: number): boolean;

    /** This function returns true if CFG replcation is enabled for the specified replication target, otherwise it returns false. **/
    configurationTargetGetReplicateCpf(cfg: configuration), targetId: number): boolean;

    /** This function returns the HTTP options configured for the specified replcation target. **/
    configurationTargetGetHttpOptions(cfg: configuration), targetId: number): http-options);

    /** This function returns the filter module used by the specified replcation target. **/
    configurationTargetGetFilterModule(cfg: configuration), targetId: number): filter-module);

    /** This function retunrs the filter options configured for the specified replcation target. **/
    configurationTargetGetFilterOptions(cfg: configuration), targetId: number): filter-options);

    /** This function sets the name of the specified replcation target. **/
    configurationTargetSetName(cfg: configuration), targetId: number, name: string): configuration);

    /** This function sets the URLs for the specified replication target. **/
    configurationTargetSetUrls(cfg: configuration), targetId: number, urls: string): configuration);

    /** This function sets the replication retry minimum value for the specified replication target. **/
    configurationTargetSetRetrySecondsMin(cfg: configuration), targetId: number, val: number): configuration);

    /** This function sets the replication retry maximum value for the specified replication target. **/
    configurationTargetGetRetrySecondsMax(cfg: configuration), targetId: number): number;

    /** This function sets the documents-per-batch value for the specified replication target. **/
    configurationTargetSetDocumentsPerBatch(cfg: configuration), targetId: number, val: number): configuration);

    /** This function enables or disables the specified replication target. **/
    configurationTargetSetEnabled(cfg: configuration), targetId: number, val: boolean): configuration);

    /** This function enables and disables CPF replication. **/
    configurationTargetSetReplicateCpf(cfg: configuration), targetId: number, val: boolean): configuration);

    /** This function sets the HTTP options on the specified replication target. **/
    configurationTargetSetHttpOptions(cfg: configuration), targetId: number, val: http-options)): configuration);

    /** This function sets the specified filter for this replication configuration. **/
    configurationTargetSetFilterModule(cfg: configuration), targetId: number, uri: string): configuration);
    ...
    configurationTargetSetFilterOptions(cfg: configuration), targetId: number, val: filter-options)): configuration);
    ...
    pullSetHttpOptions(pull: pull), httpOptions: http-options)): pull);
    ...
    configureDatabase(config: element(configuration), dbid: number): element(configuration);

    /** This function applies an update element to the current database. **/
    apply(update: update), content: document-node()): void;
    ...
    poll(domainId: number, targetId: number, start: number, size: number, forestIds: number): node();
    ...
    process(domainId: number, size?: number, targets?: number, forestIds?: number, uris?: string): results);
    ...
    documentStatus(domainId: number, uri: string): document-status);

    /** This function returns the ID for the specified pull configuration. **/
    pullGetId(pull: pull)): number;
    ...
    targetErrorDocuments(domainId: number, targetIds: number): document-target-status);
    ...
    domainTargetReset(domainId: number, targetIds: number, errorsOnly?: boolean): void;
    ...
    documentReset(uri: string, domainId: number, targetIds?: number): void;

    /** This function sets the replication retry maximum value for the specified replication target. **/
    configurationTargetSetRetrySecondsMax(cfg: configuration), targetId: number, val: number): configuration);

    /** This function.... **/
    validateUrl(url: string): string;

    /** This function.... **/
    applyEncodedUpdates(dts: domain-target-status), boundary: string, data: binary()): element();

    /** This function.... **/
    replicate(uri: string, label: string, cfg: configuration), domain: domain), docStatus: document-status), isDelete: boolean, isRetry: boolean): error);

    /** This function.... **/
    multipartEncode(boundary: string, parts: node()): binary();

    /** This function.... **/
    ackApply(domainId: number, targetId: number, acks: ack)): error);

    /** This function.... **/
    validateName(name: string): string;

    /** This function returns the pull replication configuration for the specified Pull ID. **/
    pullGetById(pullId: number, assert?: boolean): pull);
    ...
    pushLocalForest(domainId: number, forestId: number, maxSpawn: number): void;
    ...
    databaseNeedsConfiguration(config: element(configuration), dbid: number): boolean;

    /** This function.... **/
    pushForestBinaries(domainId: number, targetId: number, forestId: number, maxSpawn: number): void;

    /** This function.... **/
    pushBinary(domainId: number, targetId: number, forestId: number, key: number): void;

    /** This function.... **/
    pushBinaryChunk(statusDoc: document-node(), useServerField: boolean): number;

    /** This function.... **/
    pushBinaryDocs(domainId: number, targetId: number, forestId: number, map: map): results);
    ...
    /** This function.... **/
    pushBinaries(domainId: number): void;

    /** This function.... **/
    pollBinaryChunk(): number;

    /** This function.... **/
    getUpdateBinarydocUri(domainId: number, targetId: number, key: number): string;

    /** This function.... **/
    pullBinaries(pull: pull), maxSpawn: number): element();

    /** This function.... **/
    pullBinaryChunk(pull: pull)): number;

    /** This function.... **/
    ackBinaryChunkApply(domainId: number, targetId: number, key: number, offset: number, subsize: number): error);

    /** This function.... **/
    targetBinaryPushStatusDocuments(domainId: number, targetIds: number): binary-push-status);

    /** This function.... **/
    targetBinaryPushStatusDocument(domainId: number, targetId: number, uri: string): binary-push-status);

    /** This function.... **/
    _binaryPushStatusUri(domainId: number, targetId: number, key: number): string;

    /** This function.... **/
    coalesceDomainStatuses(domainId: number): void;

    /** This function.... **/
    pullCheckDuplicate(pull: pull)): pull);
    ...
    configurationSetAlertingUri(cfg: configuration), uri: string): configuration);

    /** Get the alerting URI associated with a FlexRep configuraiton. **/
    configurationGetAlertingUri(cfg: configuration)): string;
    ...
    domainAlertingUri(domainId: number): string;
    ...
    pushLocalForestTarget(domainId: number, targetId: number, forestId: number, maxSpawn: number): void;
    ...
    getTargetName(domainId: number, targetId: number): string;

    /** Get the user ID associated with a target, if one exists. Only query-based targets have an associated user ID. **/
    configurationTargetGetUserId(cfg: configuration), targetId: number): number;

    /** Get the immediate push flag for a target. **/
    configurationTargetGetImmediatePush(cfg: configuration), targetId: number): boolean;
    ...
    configurationTargetSetUserId(cfg: configuration), targetId: number, userId: number): configuration);
    ...
    configurationTargetSetImmediatePush(cfg: configuration), targetId: number, immediatePush: boolean): configuration);
    ...
    configurationTargetGetExternalUser(cfg: configuration), targetId: number): external-user);

    /** This function creates an inbound filter element. **/
    inboundFilterCreate(filterModule: string, filterOptions: filter-options)): inbound-filter);
    ...
    inboundFilterInsert(filter: inbound-filter)): void;
