...
// Definitions: /Users/gjosten/Projects/github-grtjn/marklogic-typescript-definitions/xml/NodeBuiltins.xml
...
declare module NodeBuiltins {
  ...
  interface fn {
    ...
    namespaceUri(arg?: node()): xs:anyURI;
    ...
    number(arg?: xs:anyAtomicType): xs:double;
    ...
    lang(testlang: xs:string, node?: node()): xs:boolean;
    ...
    generateId(node?: node()): xs:string;
