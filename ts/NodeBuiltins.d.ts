...
interface fnFunctions {
  ...
  localName(arg?: MLNode<any>): string;
  ...
  namespaceUri(arg?: MLNode<any>): string;
  ...
  lang(testlang: string, node?: MLNode<any>): boolean;
  ...
  root(arg?: MLNode<any>): MLNode<any>;
  ...
  generateId(node?: MLNode<any>): string;
