...
// Definitions: /Users/gjosten/Projects/github-grtjn/marklogic-typescript-definitions/xml/custom-dictionary.xml
...
declare module CustomeDictionaryModule {
  ...
  interface cdict {
    ...
    dictionaryDelete(lang: xs:string): void;
    ...
    dictionaryRead(lang: xs:string): element(cdict:dictionary);
    ...
    dictionaryWrite(lang: xs:string, dict: element(cdict:dictionary)): void;
