...
interface scFunctions {
  ...
  simpleType(arg?: string): SimpleType;
  ...
  complexType(arg?: string): ComplexType;
  ...
  typeApply(type: SchemaType, arg: string): string;
  ...
  elementDecl(arg?: string): ElementDecl;
  ...
  attributeDecl(arg?: string): AttributeDecl;
  ...
  annotations(arg?: SchemaComponent): MLNode<any>;
  ...
  facets(arg?: SchemaComponent): SchemaFacet;
  ...
  componentProperty(propname: string, arg?: SchemaComponent): string;
