...
interface fnFunctions {
  ...
  resolveQName(qname: string, element: MLNode<any>): xs.QName;
  ...
  namespaceUriForPrefix(prefix: string, element: MLNode<any>): string;
  ...
  inScopePrefixes(element: MLNode<any>): string;
