...
declare module QNameBuiltins {
  ...
  interface fn {
    ...
    resolveQName(qname: string, element: element()): QName;
    ...
    QName(paramURI: string, paramQName: string): QName;
    ...
    expandedQName(paramURI: string, paramLocal: string): QName;
    ...
    namespaceUriFromQName(arg: QName): anyURI;
    ...
    namespaceUriForPrefix(prefix: string, element: element()): anyURI;
    ...
    inScopePrefixes(element: element()): string;
