...
declare module Extensions {
  ...
  interface sem {
    ...
    sparql(sparql: string, bindings?: map, options?: string, store?: store): item();
    ...
    sparqlUpdate(sparql: string, bindings?: map, options?: string, store?: store, defaultPermissions?: permission), defaultPermissions?: Object[]): void;
    ...
    store(options?: string, query?: query): store;
