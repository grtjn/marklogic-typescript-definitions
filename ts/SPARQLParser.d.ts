...
interface semFunctions {
  ...
  sparql(sparql: string, bindings?: {[key:string]:any}, options?: string, store?: sem.Store): string;
  ...
  sparqlUpdate(sparql: string, bindings?: {[key:string]:any}, options?: string, store?: sem.Store, defaultPermissions?: Object[]): void;
  ...
  store(options?: string, query?: cts.Query): sem.Store;
