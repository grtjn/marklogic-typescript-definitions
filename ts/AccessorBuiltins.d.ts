...
interface fnFunctions {
  ...
  nodeName(arg: MLNode<any>): xs.QName;
  ...
  documentUri(arg: MLNode<any>): string;
...
interface xdmpFunctions {
  ...
  nodeKind(node: MLNode<any>): string;
  ...
  atomizable(item?: string): boolean;
