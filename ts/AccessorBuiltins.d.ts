...
declare module AccessorBuiltins {
  ...
  interface fn {
    ...
    data(arg: item()): xs:anyAtomicType;
    ...
    documentUri(arg: node()): xs:anyURI;
    ...
    atomizable(item?: any): xs:boolean;
